...
/* devices */
#define TAPEDEV (((TAPEINT - MAINDEVOFFSET) * DEVREGSIZE * DEVPERINT) + INTDEVREG)
#define DISKDEV (((DISKINT - MAINDEVOFFSET) * DEVREGSIZE * DEVPERINT) + INTDEVREG)
#define PRINTERDEV (INTDEVREG + (PRNTINT - MAINDEVOFFSET) * DEVREGSIZE * DEVPERINT)
